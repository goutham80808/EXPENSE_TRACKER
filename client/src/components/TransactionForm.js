...
export default function TransactionForm({
  ...
  editTransaction,
  setEditTransaction,
  sortTransactions, // Function to sort transactions
}) {
    ...
    <>
      ...
      <Card sx={{ minWidth: 275, marginTop: 2 }}>
        ...
        <Box sx={{ display: "flex", justifyContent: "center", marginTop: 2 }}>
          <Button onClick={handleSortByAmountAsc} variant="outlined">
            Sort by Amount Asc
          </Button>
          <Button onClick={handleSortByAmountDesc} variant="outlined">
            Sort by Amount Desc
          </Button>
          <Button onClick={handleSortByDateAsc} variant="outlined">
            Sort by Date Asc
          </Button>
          <Button onClick={handleSortByDateDesc} variant="outlined">
            Sort by Date Desc
          </Button>
        </Box>
      </Card>
